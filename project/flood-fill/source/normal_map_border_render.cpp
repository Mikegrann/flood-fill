...
const std::string NormalMapBorderRender::VERTEX_SHADER_FILE = "vertex-normal-map-border.glsl";
const std::string NormalMapBorderRender::FRAGMENT_SHADER_FILE = "fragment-normal-map-border.glsl";

NormalMapBorderRender::NormalMapBorderRender() : RenderElement() {}

void NormalMapBorderRender::loadShader(){
...
void NormalMapBorderRender::setupEnviroment(){
    glPolygonMode(GL_FRONT_AND_BACK, GL_FILL);
    glEnable(GL_CULL_FACE);
}

void NormalMapBorderRender::tearDownEnviroment(){
...
void NormalMapBorderRender::setupShader(){
...
void NormalMapBorderRender::setupMesh(Mesh* mesh){
...
void NormalMapBorderRender::renderObject(ObjectPtr object){
...
void NormalMapBorderRender::addObject(ObjectPtr object) {
    RenderElement::addObject(object);
    RenderEngine::getRenderElement("shadow")->addObject(object);
}

void NormalMapBorderRender::removeObject(ObjectPtr object) {
